...
function generateRandomString($length = 10) {
    ...
    return $randomString;
        ...
        $uid_pengiriman = ($_POST['uid_pengiriman'] = "MT220921002");
        ...
        $insert = "INSERT INTO pesanan (id_pesanan, uid_pengiriman,uid_user, catatan, grand_total, no_telp, tanggal_selesai, status_pesanan, alamat) 
        VALUES ('".$id_pesanan."','".$uid_pengiriman."','".$uid_user."','".$catatan."','".$grand_total."','".$no_telp."',DATE_ADD(NOW(), INTERVAL 5 DAY),'".$status_pesanan."','".$alamat."')";
